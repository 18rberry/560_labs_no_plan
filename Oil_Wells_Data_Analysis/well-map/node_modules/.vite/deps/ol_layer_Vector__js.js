...
import {
  ...
  canvasPool
} from "./chunk-TLE3UMIP.js";
import {
  BaseVector_default,
  Icon_default
} from "./chunk-DHLLYYCJ.js";
import "./chunk-7WNQL2LI.js";
import "./chunk-BDAW2UU2.js";
import {
  asColorLike,
  defaultFillStyle,
  defaultFont,
  ...
  registerFont
} from "./chunk-43XMMG66.js";
import "./chunk-LSJPGZPU.js";
import "./chunk-365ATJTS.js";
import "./chunk-GRDO3U5A.js";
import {
  EventType_default
} from "./chunk-WYIC6KAC.js";
import {
  ViewHint_default
} from "./chunk-W5YHP3DI.js";
import {
  inflateCoordinates,
  inflateCoordinatesArray,
  inflateMultiCoordinatesArray,
  snap
} from "./chunk-U6Q7F3AD.js";
import "./chunk-DXDHEMJU.js";
import {
  rotate,
  transform2D,
  transformGeom2D
} from "./chunk-XEXS4CIT.js";
import "./chunk-TX7227X5.js";
import "./chunk-74SD2LVC.js";
import "./chunk-FX3RSYGR.js";
...
import {
  ...
  create,
  setFromArray
} from "./chunk-LCNLN4NW.js";
import "./chunk-QFCIXVZ3.js";
import {
  createCanvasContext2D,
  releaseCanvas
} from "./chunk-ZV6QSF4G.js";
import "./chunk-CWNNA2SS.js";
import {
  ascending,
  descending,
  equals,
...
import {
  ...
  toUserResolution,
  wrapX as wrapX2
} from "./chunk-YK5UJQMJ.js";
import {
  clamp,
  lerp,
  toFixed
} from "./chunk-VWRUYEUX.js";
import {
...
var CanvasBuilder = class extends VectorContext_default {
  ...
  strokeStyleToState(strokeStyle, state = {}) {
    if (strokeStyle) {
      ...
      state.strokeOffset = strokeStyleOffset != null ? strokeStyleOffset : defaultStrokeOffset;
...
function offsetLineString(flatCoordinates, stride, offset, isClosedRing, dest, destinationStride) {
  dest = dest != null ? dest : [];
  destinationStride = destinationStride != null ? destinationStride : stride;
    ...
    while (i < ii) {
      ...
      switch (type) {
        ...
        case Instruction_default.CIRCLE:
          d = instruction[1];
          lineOffsetPx = (_a = instruction[2]) != null ? _a : 0;
        ...
        case Instruction_default.MOVE_TO_LINE_TO:
          ...
          isClosedRing = (_b = instruction[4]) != null ? _b : false;
  ...
  setFillStrokeStyle(fillStyle, strokeStyle) {
    ...
    if (!strokeStyle) {
      ...
      this.strokeState_ = {
        ...
        strokeOffset: (strokeOffset != null ? strokeOffset : 0) * this.pixelRatio_
      };
    }
  }
